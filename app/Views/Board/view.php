        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">자유 게시판</h1>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row board-header">
                                        <div class="col-md-12">
                                            <h4 class="title small font-weight-bold text-gray-900">안녕하세요 제목입니다.</h4>
                                            <div class="board-info d-flex justify-content-between small text-gray-700">
                                                <div class="d-flex">
                                                    <span class="user-id">kojihun123123</span>
                                                    <span class="board-date">2022.06.01 19:21</span>
                                                </div>

                                                <div class="d-flex">
                                                    <span class="board-search-cnt">조회 10</span>
                                                    <span class="board-like-cnt">추천 3</span>
                                                    <span class="board-reply-cnt">댓글 5</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>      
                                    ...
                                    <div class="row board-view">
                                        <div class="col-md-12 board-content">
                                            <div>안...</div>
                                            <div>sdfsdfsdfsdl.jmsdflkadmnmfpasdjmfipajmsfoipsejmfoipajfsnweoi</div>
                                        </div>

                                        <div class="board-recommend col-md-12 mt-5">
                                            <div class="d-flex justify-content-center">
                                                <div class="mr-3">
                                                    <span class="like-num text-lg mr-3">3</span>
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <span class="dislike-num text-lg ml-3">1</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">
                                                        <div class="d-flex justify-content-between">
                                                            <span>kojihun123123</span>
                                                            <span><p>정말재밌는글이네요</p></span>
                                                            <span></span>
                                                            <span></span>
                                                            <span>06.01 20:20:15</span>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <div class="d-flex justify-content-between">
